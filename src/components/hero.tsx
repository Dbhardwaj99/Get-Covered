...
const Hero = () => {
  ...
  return (
    ...
    <div className=""> */}
        <div
          className="border-2 border-gray-300 rounded-lg p-4 w-3/4 max-w-lg bg-white text-gray-700 cursor-text min-h-[100px] flex items-center justify-center"
        ...
        {showArticle && (
          <div
            className="border-2 border-gray-300 rounded-lg p-4 w-3/4 max-w-lg bg-white text-gray-700 mt-4"
          >
            <h2 className="text-xl font-bold mb-2">Generated Article</h2>
            <p>This is the content of the generated article. It will replace the placeholder text when the "Generate" button is clicked.</p>
